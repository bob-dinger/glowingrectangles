...
<style>
  ...
  .main { flex:1; padding:0; display:flex; flex-direction:column; overflow:hidden; min-height:0; }
  .structure-pane, .expanded-pane { display:none; flex:1; min-height:0; }
  .structure-pane.active { display:block; overflow-y:auto; padding:24px 36px; }
  .expanded-pane.active { display:flex; flex-direction:column; }
