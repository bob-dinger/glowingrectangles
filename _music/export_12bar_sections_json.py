...
Output: ~/Desktop/glowinggardens_claude/_music/twelve_bar_sections.json
        (loaded by twelve-bar-sections.html for browsing)
"""
import os, json, re
...
OUT = '/Users/robert/Desktop/glowinggardens_claude/_music/twelve_bar_sections.json'
...
def main():
    ...
    for song in rows:
        ...
        for i, sec in enumerate(sections):
            ...
            if not (11.9 <= n_meas <= 12.1): continue
