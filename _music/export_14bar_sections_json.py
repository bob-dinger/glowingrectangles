"""Export 14-measure sections with melody from Supabase, with chord+melody detail.

Output: ~/Desktop/glowinggardens_claude/_music/fourteen_bar_sections.json
"""
import os, json, re
...
OUT = '/Users/robert/Desktop/glowinggardens_claude/_music/fourteen_bar_sections.json'
...
def main():
    ...
    for song in rows:
        ...
        for i, sec in enumerate(sections):
            ...
            if not (13.9 <= n_meas <= 14.1): continue
