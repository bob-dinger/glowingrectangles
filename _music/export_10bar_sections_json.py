...
Output: ~/Desktop/glowinggardens_claude/_music/ten_bar_sections.json
        (loaded by ten-bar-sections.html for browsing)
"""
import os, json, re
...
OUT = '/Users/robert/Desktop/glowinggardens_claude/_music/ten_bar_sections.json'
...
def main():
    ...
    for song in rows:
        ...
        for i, sec in enumerate(sections):
            ...
            if not (9.9 <= n_meas <= 10.1): continue
