<template>
  <div class="post_container">
    <h1 id="dillinger">Second Post</h1>
    <h2 id="_the-last-markdown-editor-ever_"><em>The Last Markdown Editor, Ever</em></h2>
    <p>
      <a href="https://nodesource.com/products/nsolid"
        ><img src="https://cldup.com/dTxpPi9lDf.thumb.png" alt="N|Solid"
      /></a>
    </p>
    <p>
    ...
    <p>
      ...
      people naturally use in email. As
    ...
    <ul>
      ...
      <li>
        <a href="http://ace.ajax.org">Ace Editor</a> - awesome web-based text editor
      </li>
      <li>
        <a href="https://github.com/markdown-it/markdown-it">markdown-it</a> - Markdown
        parser done right. Fast and easy to extend.
      </li>
      <li>
        <a href="http://twitter.github.com/bootstrap/">Twitter Bootstrap</a> - great UI
        boilerplate for modern web apps
      </li>
      <li><a href="http://nodejs.org">node.js</a> - evented I/O for the backend</li>
      <li>
        <a href="http://expressjs.com">Express</a> - fast node.js network app framework
        <a href="http://twitter.com/tjholowaychuk">@tjholowaychuk</a>
      </li>
      <li><a href="http://gulpjs.com">Gulp</a> - the streaming build system</li>
      <li>
        <a href="https://breakdance.github.io/breakdance/">Breakdance</a> - HTML to
        Markdown converter
      </li>
    ...
    <p>
      ...
      <a href="https://github.com/joemccann/dillinger">public repository</a> on GitHub.
    </p>
...
<span class="hljs-attr">NODE_ENV=</span>production <span class="hljs-keyword">node</span> <span class="hljs-title">app</span>
    ...
    <p>
      Dillinger is currently extended with the following plugins. Instructions on how to
        ...
        <tr>
          ...
          <td>
            <a
              ...
              >plugins/googledrive/README.md</a
            >
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <a
              ...
              >plugins/googleanalytics/README.md</a
            >
          </td>
        </tr>
      </tbody>
    ...
    <p>
      Dillinger uses Gulp + Webpack for fast developing. Make a change in your file and
    ...
    <p>Second Tab:</p>
    <pre><code class="lang-sh"><span class="hljs-attribute">gulp watch</span>
</code></pre>
    <p>(optional) Third:</p>
    ...
    <pre><code class="lang-sh">gulp build <span class="hljs-comment">--prod</span>
</code></pre>
    <p>Generating pre-built zip archives for distribution:</p>
    <pre><code class="lang-sh">gulp <span class="hljs-keyword">build </span><span class="hljs-keyword">dist </span>--prod
</code></pre>
    <h2 id="docker">Docker</h2>
    <p>Dillinger is very easy to install and deploy in a Docker container.</p>
    <p>
      By default, the Docker will expose port 8080, so change this within the Dockerfile
      if necessary. When ready, simply use the Dockerfile to build the image.
    </p>
    <pre><code class="lang-sh"><span class="hljs-keyword">cd</span> dillinger
docker build -t &lt;youruser&gt;/dillinger:<span class="hljs-variable">${package</span>.json.<span class="hljs-keyword">version</span>} .
</code></pre>
    <p>
      This will create the dillinger image and pull in the necessary dependencies. Be sure
      to swap out <code>${package.json.version}</code> with the actual version of
      Dillinger.
    </p>
    <p>
      Once done, run the Docker image and map the port to whatever you wish on your host.
      In this example, we simply map port 8000 of the host to port 8080 of the Docker (or
      whatever port was exposed in the Dockerfile):
    </p>
    <pre><code class="lang-sh">docker run -d -<span class="hljs-selector-tag">p</span> <span class="hljs-number">8000</span>:<span class="hljs-number">8080</span> --restart=always --cap-add=SYS_ADMIN --name=dillinger &lt;youruser&gt;/dillinger:${package<span class="hljs-selector-class">.json</span><span class="hljs-selector-class">.version</span>}
</code></pre>
    <blockquote>
